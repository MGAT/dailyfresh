...
def login_handle(request):
    ...
    # 根据用户名查询对象
    users = UserInfo.objects.filter(uname=uname) #[] return object is a list
    # print uname
    ...
    if len(users) == 1:
        ...
        if s1.hexdigest() == users[0].upwd:
            red = HttpResponseRedirect('/user/info') # HttpResponseRedirect 继承 HttpResponse 可以设置cookie
            ...
            if jizhu != 0:
                ...
                red.set_cookie('uname', '', max_age=-1) #max_age=-1（<0) 表示立马失效
